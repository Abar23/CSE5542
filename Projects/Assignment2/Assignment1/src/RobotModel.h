...
public:
	...
	void RotateRobotGlobally(glm::mat4 *rotationMatrix);
...
private:
	...
	static void UpdateAppendageGlobalRotation(unsigned int childIndexOfModel, unsigned int numberOfComponents, ModelNode *body, glm::mat4 *globalRotation);
};
